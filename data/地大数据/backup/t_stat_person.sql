...
-- ----------------------------
-- Table structure for t_stat_person
-- ----------------------------
DROP TABLE IF EXISTS `t_stat_person`;
CREATE TABLE `t_stat_person`  (
  ...
  `login_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
