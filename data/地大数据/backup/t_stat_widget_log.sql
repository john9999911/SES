...
-- ----------------------------
-- Table structure for t_stat_widget_log
-- ----------------------------
DROP TABLE IF EXISTS `t_stat_widget_log`;
CREATE TABLE `t_stat_widget_log`  (
  ...
  `attend_count` int(0) NULL DEFAULT NULL,
  `send_to_student` int(0) NULL DEFAULT NULL,
