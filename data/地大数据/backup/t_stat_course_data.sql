...
-- ----------------------------
-- Table structure for t_stat_course_data
-- ----------------------------
DROP TABLE IF EXISTS `t_stat_course_data`;
CREATE TABLE `t_stat_course_data`  (
  ...
  `object_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `isDeleted` int(0) NULL DEFAULT NULL,
  `data_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
