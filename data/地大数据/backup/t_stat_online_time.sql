...
-- ----------------------------
-- Table structure for t_stat_online_time
-- ----------------------------
DROP TABLE IF EXISTS `t_stat_online_time`;
CREATE TABLE `t_stat_online_time`  (
  ...
  `online_time` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
