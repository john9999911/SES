...
-- ----------------------------
-- Table structure for t_stat_course_job
-- ----------------------------
DROP TABLE IF EXISTS `t_stat_course_job`;
CREATE TABLE `t_stat_course_job`  (
  ...
  `job_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
