...
-- ----------------------------
-- Table structure for t_stat_clazz
-- ----------------------------
DROP TABLE IF EXISTS `t_stat_clazz`;
CREATE TABLE `t_stat_clazz`  (
  ...
  `clazz_number` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `student_count` int(0) NULL DEFAULT NULL,
